...
public class ComponentContext {
    ...
    //为了在ServletContext中引用方便改成常量字符串
    public static final String CONTEXT_NAME = "org.geektimes.injection.context.ComponentContext";
...
//    }
    ...
    private void injectComponents(Object component, Class<?> componentClass) {
        System.out.println("component is " + component + " and componentClass is " + componentClass);
        ...
        Stream.of(componentClass.getDeclaredFields())
            ...
            logger.log(Level.INFO, "注入资源： " + resourceName);
